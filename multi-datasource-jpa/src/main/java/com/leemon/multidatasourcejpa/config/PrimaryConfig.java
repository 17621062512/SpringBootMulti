package com.leemon.multidatasourcejpa.config;
...
@EnableJpaRepositories(entityManagerFactoryRef = "entityManagerFactoryPrimary", //EntityManagerFactory引用
        ...
        basePackages = {"com.leemon.multidatasourcejpa.repository.primary"})//设置Repository所在位置
public class PrimaryConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactoryPrimary(EntityManagerFactoryBuilder builder) {
        LocalContainerEntityManagerFactoryBean entityManagerFactoryBean =
                builder.dataSource(primaryDataSource).properties(getVendorProperties()).packages("com.leemon.multidatasourcejpa.pojo").persistenceUnit("primaryPersistenceUnit").build();
    ...
    /**
     * 这里其实不需要配置数据库的方言.
     * 像hibernate.hbm2ddl.auto 可以在这里配置.也能在application.properties中配置的.
     */
